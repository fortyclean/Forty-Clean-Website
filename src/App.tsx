            ...
            >
                  ...
                  <div key={item.id} className="bg-gray-50 p-6 rounded-3xl border border-gray-100 relative group">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center">
                        {item.service === 'cleaning' ? <ShoppingCart className="w-6 h-6" /> : <ShoppingCart className="w-6 h-6" />}
                      </div>
                      <div>
              ...
              <div className="pt-8 border-t border-gray-100 mt-auto">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button variant="outline" onClick={clearCart} className="rounded-2xl py-6 font-bold">مسح السلة</Button>
                  <Link to="/booking" onClick={() => setIsCartOpen(false)} className="w-full">
                    <Button className="w-full bg-blue-600 py-6 rounded-2xl font-black">إتمام الحجز</Button>
                  </Link>
                </div>
              </div>
            </motion.div>
